    ...
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Link href="/cart" passHref>
          <Popover.Button className="h-full">{`Košík (${totalItems})`}</Popover.Button>
        </Link>
        <Transition
          show={state}
          as={Fragment}
        ...
        >
          ...
          >
            <div className="p-4 flex items-center justify-center">
              <h3 className="text-large-semi">Nákupní košík</h3>
            </div>
            {cart && items?.length ? (
              <>
                  ...
                  <div>
                    <Link href="/store">
                      <a>
                        ...
                        <Button onClick={close}>Zobrazit produkty</Button>
                      </a>
                    </Link>
                  </div>
                </div>
